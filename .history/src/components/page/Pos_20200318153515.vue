          ...
          <div class="goods-type">
            <el-tabs>
              <el-tab-pane label="主食">
                <div>
                  <ul class="cookList">
                    <li v-for="food in stapleFoodList" @click="addOrderList(good)">
                      <span class="foodImg">
              ...
              <el-tab-pane label="小食">
                <div>
                  <ul class="cookList">
                    <li v-for="food in snackList" @click="addOrderList(good)">
                      <span class="foodImg">
                        <img :src="food.img" width="100px" height="80px" />
                      </span>
                      <span class="foodName">{{food.goodsName}}</span>
              ...
              <el-tab-pane label="饮料">
                <div>
                  <ul class="cookList">
                    <li v-for="food in drinkList" @click="addOrderList(good)">
                      <span class="foodImg">
                        <img :src="food.img" width="100px" height="80px" />
                      </span>
                      <span class="foodName">{{food.goodsName}}</span>
