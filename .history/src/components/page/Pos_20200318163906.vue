              ...
              <el-table :data="tableDate" border style="width:100%">
                ...
                <el-table-column label="操作" width="100px" fixed="right">
                  <template slot-scope="scope">
                    <el-button type="text" size="small" @click="deleteOneGood(scope.row)">-1</el-button>
                    <el-button type="text" size="small" @click="addOrderList(scope.row)">+1</el-button>
                  </template>
                </el-table-column>
              </el-table>
              <div class="total">
...
export default {
  ...
  methods: {
    ...
    deleteOneGood(good){
      ...
      arr[0].count--;
      if(arr[0].count<=0){
        this.tableDate = this.tableDate.filter(o => o.goodsId != good.goodsId);
      }
      this.totalCount--;
